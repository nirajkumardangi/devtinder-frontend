...
function Chat() {
  ...
  return (
    <>
      <div className="absolute inset-0 z-10 flex items-center justify-center text-4xl font-bold">
        Coming soon
      </div>

      <div className="blur-sm rw-full min-h-screen bg-[#0B101B] py-10 px-4 font-sans text-slate-200">
